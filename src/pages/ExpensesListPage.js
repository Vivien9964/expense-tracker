      ...
      {expenses.length === 0 ? (
        ...
        <div>
          <div className={`card ${styles.filterCard}`}>
            <h3 className={styles.filterTitle}>Filter Expenses</h3>
            <div className={styles.filterGrid}>
              <div className={styles.filterGroup}>
                <label className={styles.filterLabel}>Search by title:</label>
                <input
                  type="text"
              ...
              <div className={styles.filterGroup}>
                <label className={styles.filterLabel}>Filter by Amount:</label>
                <select
                  value={searchAmount}
          ...
          <div className={`card ${styles.summaryCard}`}>
            ...
            <div className={styles.summaryStats}>
              ...
              <p className={styles.summaryAmount}>
                <strong>Total Amount: ${totalCosts.toFixed(2)}</strong>
              </p>
            </div>
          </div>
